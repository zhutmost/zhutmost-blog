...
category: 🌈 Docs
banner: /images/posts/docs/comment/banner.jpg
tags:
  - analog
  - comment
---
...
Next, fill in the corresponding fields in the user configuration file `/data/site-config.ts`:
...
Now, you can see the Giscus comment widget at the bottom of your posts (like this one).

## See Also

The comment system in Analog is driven by the [timlrx/pliny](https://github.com/timlrx/pliny).
Please visit it for detailed configurations.
